...
\begin{itemize}
	...
	\item and {\color{kthesis-glance}Markers} indicating key claims in the thesis statement (e.g., \stmtno{1}) or key elements of other works' design which benefit from glance value (e.g., \rllitstate, \rllitact).
\end{itemize}