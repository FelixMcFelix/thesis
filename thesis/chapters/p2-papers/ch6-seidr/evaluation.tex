...
\begin{figure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics{plots/seidr/2class-results.pdf}}
...
\begin{figure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics{plots/seidr/4class-results.pdf}}
...
\Cref{fig:4c-results} shows in the \emph{4-class} case that we observe a sharp loss in classification accuracy, peaking at \qty{59.5 +- 2}{\percent} for \glspl{acr:cnn} and \SI{64.5 +- 1.6}{\percent} for \glspl{acr:knn}.
...
\begin{figure}
    \centering
    \resizebox{\linewidth}{!}{\includegraphics{plots/seidr/compression-v6.pdf}}
