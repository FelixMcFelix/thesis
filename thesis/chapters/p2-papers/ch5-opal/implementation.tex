\approachshort{} is implemented as a collection of programs targeting the Netronome \gls{acr:nfp} family of SmartNICs, using a mixture of the proprietary Micro-C language and P4.
