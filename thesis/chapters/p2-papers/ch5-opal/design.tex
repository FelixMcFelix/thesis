...
?? Run through algo. \Cref{alg:parsa}
?? Task allocations per core are deployment-specific. and impl detail (but I cover this) Why? Different tasks have different complexity.
?? mention that theoretical worse than just adding more cores due to message passing costs, memfence, compiler reordering etc.
