...
What might be less obvious is that we have different needs depending on whether the main task we're interested in is inference---i.e., per-packet application of a learned flow---or in-situ learning of a function or policy.
