...
This becomes key when dealing with remote procedure call workloads common to such data centres, where completions are on an $\mathcal{O}\left(\unit{\micro\second}\right)$ timescale themselves~\parencite{DBLP:journals/cacm/BarrosoMPR17,DBLP:conf/nsdi/KaliaKA19,DBLP:conf/isca/SutherlandGFMPD20}.
...
?? Loop detection~\parencite{DBLP:conf/conext/0004BKAYM20}
...
?? Although we have discussed Taurus above...
?? Describe in more detail here

\Cref{sec:fixed-point-and-binary} for representations...
