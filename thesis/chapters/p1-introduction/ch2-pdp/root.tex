...
This expands on the raw tooling introduced throughout \cref{sec:modern-pdps} with a higher level of abstraction, and allows us to better understand how we can push general program logic on-path (as part of a full data processing pipeline).
