...
\gls{acr:pdp} hardware allows us to place more complex decisions and new algorithms at a lower level, providing a strong use case for the better state and measurements they give us access to (\cref{sec:network-monitoring}).
...
We'll consider here some ways in which \gls{acr:pdp} hardware makes the management and operation of networks easier and faster by measurement, cooperation, or novel algorithms.
