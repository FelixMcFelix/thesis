...
\begin{figure}
	...
	\caption[A microbenchmark of bypass/offload frameworks' effect on packet RTTs.]{A microbenchmark of bypass/offload frameworks' effect on packet RTTs.\label{fig:xdp-microbench}}
\end{figure}

\Cref{fig:xdp-microbench} shows...
``While this is \emph{a little bit} of a strawman...''

?? Earlier measurements saw a \qtyrange{39}{50}{\micro\second} gap between Native and AF when using blocking I/O (non-polling).
