...
?? ClickOS \glspl{acr:vnf}~\parencite{DBLP:conf/nsdi/MartinsAROHBH14}, ClickNF~\parencite{DBLP:conf/usenix/GalloL18}

?? Container frameworks~\parencite{DBLP:conf/iscc/CzivaJWP15,DBLP:journals/cm/CzivaP17}

?? Orchestration: optimal placement on \gls{acr:qos}~\parencite{DBLP:conf/im/Iordache-SicaAP21}, and ??~\parencite{DBLP:conf/infocom/CzivaAP18}
