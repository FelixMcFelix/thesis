...
Active Networking~\parencite{DBLP:journals/ccr/TennenhouseW96} and its reflection~\parencite{DBLP:journals/ccr/WetherallT19}. Another reflection~\parencite{DBLP:journals/ccr/Calvert06}.
...
\emph{Active networking}..
Generally speaking proposals were clean-slate in nature, standing in stark opposition to the simplicity of the end-to-end protocol.

?? focus on programmable \emph{dataplane} rather than control plane

?? My notes on the road to SDN:
?? Try here to differentiate dataplane programmability from control plane programmability.
?? 

Programmable switches~\parencite{DBLP:journals/network/AlexanderAHKKMG98}

Capsules~\parencite{DBLP:conf/dance/Wetherall02}
?? Investigate how they proposed to run -- langs etc.?

PlanetLab~\parencite{DBLP:journals/ccr/ChunCRBPWB03}
...
\subsection{Modern, Programmable Dataplanes}
