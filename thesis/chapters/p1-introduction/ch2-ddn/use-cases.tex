...
\emph{Alohamora}~\parencite{DBLP:conf/nsdi/KansalRN21} uses \gls{acr:drl} to generate \gls{acr:http}/2\sidenote{?? make sure I use HTTP somewhere sooner to contract this...} asset push and preload policies to reduce page load times over limited networks or on constrained devices.
