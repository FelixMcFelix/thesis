...
In the case of variable length sequences of data (i.e., an obvious time-series use case such as audio transcoding), \glsxtrfullpl{acr:rnn}~\parencite{Rumelhart1986} capture temporal properties of the input.
