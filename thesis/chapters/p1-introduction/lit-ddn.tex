...
\begin{marginfigure}
	\centering
	\resizebox{0.9\linewidth}{!}{\includegraphics{diagrams/nns/single-neuron-draft}}
...
\begin{figure}
	\centering
	\resizebox{0.9\linewidth}{!}{\includegraphics{diagrams/nns/fcnn-draft}}
...
?? Learn a convolution filter to apply to a layer
...
?? Captures temporal properties of the input: feeds neuron state from last input into calculation of current (similar to IIR filter).
?? RNNs?
?? GRUs?
