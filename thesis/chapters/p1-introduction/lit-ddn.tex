...
\input{chapters/p1-introduction/ch2-ddn/fn-approx.tex}

\section{Collaborative training}\label{sec:ddn-collaborative-training}
\input{chapters/p1-introduction/ch2-ddn/distributed-ml.tex}

\section{Numerical representations for embedded ML}\label{sec:numerical-representations-for-embedded-ml}
\input{chapters/p1-introduction/ch2-ddn/representations.tex}

\section{Challenges}\label{sec:ddn-challenges}
\input{chapters/p1-introduction/ch2-ddn/challenges.tex}

\section{Security}\label{sec:ddn-security}
\input{chapters/p1-introduction/ch2-ddn/security.tex}
