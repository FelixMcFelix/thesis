...
\begin{marginfigure}
	Test..
	\caption[A motivating example for MDPs.]{A toy example showing...}\label{fig:toy-rl-motiv}
\end{marginfigure}
...
\begin{marginfigure}
	Test
	\caption[An illustration of how value adjustments in single-step RL propagate backwards through a state trajectory.]{Test.}\label{fig:sarsa-intuition}
\end{marginfigure}

\begin{figure}
	Test.
	\caption[A worked example showing how $\epsilon$-greedy Sarsa performs inference and learning with a tile coded function approximation.]{Put the worked example from TNSM paper here.}\label{fig:sarsa-end-to-end}
\end{figure}
...
To see how this combines with a simple linear function approximation, consider \cref{fig:sarsa-end-to-end}.
...
\begin{figure}
	\begin{subfigure}{0.45\linewidth}
		\centering
		\resizebox{0.9\linewidth}{!}{\input{diagrams/rl/sa-slip1}}
