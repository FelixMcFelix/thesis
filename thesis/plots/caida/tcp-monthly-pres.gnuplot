...
set output "tcp-monthly-pres.tex"
...
plot '../results/dirA-1.csv' u 14: xtic(1) title "Dir A (Packets)" lc palette frac 0.25, \
     '../results/dirB-1.csv' u 14 title "Dir B (Packets)" lc palette frac 0.5, \
     '../results/biDir-1.csv' u 14 title "Both (Packets)" lc palette frac 0.75