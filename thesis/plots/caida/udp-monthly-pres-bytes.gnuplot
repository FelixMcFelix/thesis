...
set output "udp-monthly-pres-bytes.tex"
...
plot '../results/dirA-1.csv' u 17: xtic(1) title "Dir A (Bytes)" lc palette frac 0.25, \
     '../results/dirB-1.csv' u 17 title "Dir B (Bytes)" lc palette frac 0.5, \
     '../results/biDir-1.csv' u 17 title "Both (Bytes)" lc palette frac 0.75