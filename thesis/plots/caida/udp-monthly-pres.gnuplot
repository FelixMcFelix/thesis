...
set output "udp-monthly-pres.tex"
...
plot '../results/dirA-1.csv' u 16: xtic(1) title "Dir A (Packets)" lc palette frac 0.25, \
     '../results/dirB-1.csv' u 16 title "Dir B (Packets)" lc palette frac 0.5, \
     '../results/biDir-1.csv' u 16 title "Both (Packets)" lc palette frac 0.75