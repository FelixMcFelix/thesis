...
set output "mss-confusion-3.tex"
...
set cbrange[0:18337.6]

plot '../results/lstm-multiplex-ss-confusion-3.csv' matrix u 1:2:3 with image pixels notitle, \
	"../results/lstm-multiplex-confusion-3.csv" matrix u 1:2:($3 == 0 ? "" : sprintf("%g",($3/18337.6))) with labels notitle
