...
set output "cubic-vs-bbr-precision.tex"
...
plot "< awk -F, '$3==20 { print $0 }' ../results/lstm-results.csv" u 1:7 w linespoints title "20 Units" ls 3 dt 1, \
     "< awk -F, '$3==40 { print $0 }' ../results/lstm-results.csv" u 1:7 w linespoints title "40 Units"  ls 6 dt (18,2,2,2)
