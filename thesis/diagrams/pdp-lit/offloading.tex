...
\begin{tikzpicture}
	...
	\draw[color=ol-user, fill=ol-user,align=center,text=white, rounded corners] ($(nic) + (-2, -3.5)$) rectangle ++(2,1) node[pos=.5] (smartnic-offload) {Offload\\P4/\glslink{acr:ebpf}{\color{white}eBPF}};
	...
	\draw[<->, thick, color=ol-arrow] (mem) -- (rx-tx);
